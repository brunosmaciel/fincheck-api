import { Controller, Get, Post, Body, Patch, Param, Delete, Put, ParseUUIDPipe, Query, ParseIntPipe, HttpCode, HttpStatus } from '@nestjs/common';
import { TransactionsService } from './services/transactions.service';
import { CreateTransactionDto } from './dto/create-transaction.dto';
import { UpdateTransactionDto } from './dto/update-transaction.dto';
import { ActiveUserId } from 'src/shared/decorators/ActiveUserId';
import { OptionalParseUUIDPipe } from 'src/shared/pipes/OptionParseUUIDPipe';
import { OptionalParseEnumPipe } from 'src/shared/pipes/OptionParseEnumPipe';
...
export class TransactionsController {
  ...
  update(@ActiveUserId() userId:string,@Param('transactionId',ParseUUIDPipe) transactionId: string, @Body() updateTransactionDto: UpdateTransactionDto) {
    return this.transactionsService.update(transactionId,userId, updateTransactionDto);
  }
